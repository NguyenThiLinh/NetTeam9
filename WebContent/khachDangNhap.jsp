          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form action="KhachHangDangNhapServlet" method="post" class="form-validate">
                     <div class="form-group">
                      <input id="login-username" type="text" name="tenKhach" required data-msg="Vui lòng nhập tên đăng nhập" class="input-material">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <input id="login-maMay" type="text" name="maMay" class="input-material">
                      <label for="login-maMay" class="label-material">Mã máy</label>
                    </div>
                   ...
                   <a href="dangNhap.jsp" class="signup">Bạn là admin</a><br/>
